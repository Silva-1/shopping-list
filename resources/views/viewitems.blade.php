...
<head>
    ...
    <style>
        form {
            background-image: url('{{ url('./images/List.jpg') }}');
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <?php
                        ...
                        <a href="{{ url('additem/' . $list->id) }}" 
                            class="btn btn-primary float-end ">Add Item</a>
