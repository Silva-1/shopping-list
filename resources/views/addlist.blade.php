                        ...
                        <form action="{{ Route('sendList') }}" method="POST">
                            ...
                            <div Style="text-align: center;">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="list_name" class="form-control-product mb-3" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="">List Description: </label>
                                    <input type="text" name="list_description" class="form-control-product mb-3"
                                        required>
                                </div>
                                <input type="hidden" name="id" value={{ Auth::user()->id }}
                                    class="form-control-product mb-3" required>
                                <div class="card-footer">
                                    <button type="submit" name="btnAddList"
